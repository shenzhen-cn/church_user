...
(function ($) {
    ...
    var isIE = function (ver) {
        ...
        defaultFileActionSettings = {
            ...
            uploadIcon: '<i class="fa  fa-eye text-info"></i>',
            uploadClass: 'btn btn-xs btn-default disabled',
            uploadTitle: 'Upload file',
            indicatorNew: '<i class="fa fa-hand-o-down text-warning"></i>',
            indicatorSuccess: '<i class="fa fa-check-square file-icon-large text-success"></i>',
