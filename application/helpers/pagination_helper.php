...
if ( ! function_exists('pagination'))
{
	function pagination($total_results, $page, $results, $url, $num_of_page_links = 3) 
	{
		...
		if ($total_pages > 1)
		{
			...
			$pagination .= '<div class="pagination"><ul class="pagination pagination-sm no-margin pull-left">';
			...
			// Current page
			$_GET['page'] = $page;
			$pagination .= '<li class="active"><a href="'.$url.'?'.http_build_query($_GET).'" onclick="return false;">'.$_GET['page'].'</a></li>';
